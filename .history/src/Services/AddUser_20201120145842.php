...
class AddUser
{
    ...
    public function updateInfo($user, UserPasswordEncoderInterface $encoder, EntityManagerInterface $em, SerializerInterface $serializer,Request $request,ApprenantRepository $repoApre)
    {
        dd($user);
