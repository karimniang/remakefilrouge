...
class ReferentielService 
{
    ...
    public function __construct(AddUser $userService, ReferenceRepository $repoReferentiel, GroupeCompetenceRepository $repoGroupeComp, ValidatorInterface $validator, EntityManagerInterface $manager, SerializerInterface $serializer)
    {
