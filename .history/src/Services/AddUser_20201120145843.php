...
class AddUser
{
    ...
    public function updateInfoU($user, UserPasswordEncoderInterface $encoder, EntityManagerInterface $em, SerializerInterface $serializer,Request $request,ApprenantRepository $repoApre)
    {
        dd($user);
