...
class AddUser
{
    ...
    public function updateInfoUser($user, UserPasswordEncoderInterface $encoder, EntityManagerInterface $em, SerializerInterface $serializer,Request $request,ApprenantRepository $repoApre)
    {
        dd($user);
