...
class Groupe
{
     ...
     * @Groups({"promotion:read","promotion:read_all","promotion:read_formateur","promo_groupe_apprenants:read","apprenant:read"})
     */
    private $id;
     ...
     * @Groups({"promo_groupe_apprenants:read","groupe:read"})
