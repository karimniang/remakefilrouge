...
class Promotion
{
     ...
     * @Groups({"promotion:read","promotion:read_all","promotion:read_all_ref","promotion:read_formateur"})
     */
    private $id;

    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"promotion:write","promotion:read","promotion:read_all","promotion:read_all_ref","promotion:read_formateur"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Formateur::class, inversedBy="promotions","promotion:read_formateur")
     ...
     * @Groups({"promotion:read_all_ref","promotion:read_formateur"})
     */
