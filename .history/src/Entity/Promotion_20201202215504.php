...
class Promotion
{
     ...
     * @Groups({"promotion:read","promotion:read_all","promotion:read_all_ref","promotion:read_formateur","promo_groupe_apprenants:read"})
     */
    private $id;
     ...
     * @Groups({"promotion:read_all_ref","promotion:read_formateur","promo_groupe_apprenants:read"})
     */
