...
class Referentiel
{
     ...
     * @Groups({"referentiel:read","referentiel:read_all","promotion:read_all_ref","promotion:read_formateur","promo_groupe_apprenants:read","groupe:read"})
     */
    private $id;

    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"referentiel:read","referentiel:read_all","referentiel:write","promotion:read_all_ref","promotion:read_formateur","promo_groupe_apprenants:read","groupe:read"})
