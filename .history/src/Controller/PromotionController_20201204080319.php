...
class PromotionController extends AbstractController
{
    ...
    /**
     * @Route("/admin/promotions/{id_promo}/groupes/{id_groupe}/apprenants", name="show_promo_id_groupes_id_apprenants", methods="GET")
     */
     ...
     */
    public function editPromotionApprenants(PromotionService $promotionService, Request $request, $id){
        return $promotionService->editApprenantForPromo($id, $request);
    }
}
