...
class GroupeCompetenceController extends AbstractController
{
     ...
     */
    public function UpdateGroupeCompetence(GroupeCompetenceService $groupeCompetenceService, Request $request,$id){
        ...
        return $groupeCompetenceService->updateGroupeCompetence($request, $id);
    }
}
