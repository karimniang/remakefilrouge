...
/**
 * @ORM\Entity(repositoryClass=StatutBriefPromoRepository::class)
 */
class StatutBriefPromo
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\OneToMany(targetEntity=BriefMaPromo::class, mappedBy="statutBrief")
     */
    ...
    public function addBriefMaPromo(BriefMaPromo $briefMaPromo): self
    {
        if (!$this->briefMaPromos->contains($briefMaPromo)) {
            ...
            $briefMaPromo->setStatutBrief($this);
        }
    ...
    public function removeBriefMaPromo(BriefMaPromo $briefMaPromo): self
    {
        if ($this->briefMaPromos->removeElement($briefMaPromo)) {
            ...
            if ($briefMaPromo->getStatutBrief() === $this) {
                $briefMaPromo->setStatutBrief(null);
            }
        }
